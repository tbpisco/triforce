...
------------------------------------------------------------------------------
  ...
  */
	...
	var setupUniformAndAttributes = function(prg,gl){
	  ...
	  gl.uniform3fv(prg.uLightPosition,  [-5.0,0.0,-10.0]);
      gl.uniform4fv(prg.uLightAmbient, [0.4,0.4,0.4,1.0]);
      gl.uniform4fv(prg.uLightDiffuse,  [1.0,1.0,1.0,1.0]); 
      gl.uniform4fv(prg.uLightSpecular,  [1.0, 1.0, 1.0, 1.0]);
    
      gl.uniform4fv(prg.uMaterialAmbient, [0.8,0.8,0.0,1.0]);
      gl.uniform4fv(prg.uMaterialDiffuse, [0.8, 0.8, 0.0,1.0]);
      gl.uniform4fv(prg.uMaterialSpecular,[0.5,0.5,0.5,1.0]);
